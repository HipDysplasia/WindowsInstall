...
- Motherboard LAN driver
- Motherboard Wi-Fi driver
- Motherboard Bluetooth driver
- Motherboard audio driver
- Other device-specific drivers
- BIOS/UEFI update **only if actually needed**

Use the motherboard manufacturer's support page for the exact model/revision.
...
Windows Update may install functional versions of many of these, but use the manufacturer's current drivers when appropriate.
